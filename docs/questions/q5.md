...
??? example "Decision Log Template — Phase Gate (RGDS-DEC-IND2026-010)"
    ```json
    {
...
??? example "Evidence Completeness Tracking Schema"
    ```json
    {
      "evidence": [
        {
...
??? example "Decision Log — Completed CMC Gate (RGDS-DEC-IND2026-010)"
    ```json
    {
      "decisionid": "RGDS-DEC-IND2026-2026-010",
      "decisionquestion": "Is CMC data sufficiently complete for IND submission?",
