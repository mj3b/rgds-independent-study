...
- **`confidenceband` (string):** AI model accuracy/confidence level. Use quantitative metrics where available (F1-score, prediction accuracy, error rate).  
  Example: “87% F1 overall; 92% factual accuracy; 76% severity interpretation.”
