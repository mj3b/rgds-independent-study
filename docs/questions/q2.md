...
??? example "AI Assistance Object — Full Structure"
    ```json
    {
      "aiassistance": {
        "used": true,
...
??? example "AI Assistance Example — Medical Writing (CoAuthor)"
    ```json
    {
      "tool": "CoAuthor (Certara), v3.2",
...
??? example "AI Assistance Example — Regulatory Intelligence (IQVIA)"
    ```json
    {
...
??? example "AI Assistance Example — Digital Twin / Manufacturing (Certara)"
    ```json
    {
