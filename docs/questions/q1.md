...
Analysis of decision artifacts across **300+ asset programs** and **200+ IND submissions** identifies **five recurring failure modes** that are **not technical in origin** but **governance-driven**[[13]](../../references/bibliography/#cite13) [[16]](../../references/bibliography/#cite16) [[17]](../../references/bibliography/#cite17):
...
??? example "Decision Log Example — Data Readiness Gate (RGDS-DEC-IND2026-001)"
    ```json
    {
