...
??? example "Evidence Classification — Completeness Schema"
    ```json
    {
      "evidence": [
        {
...
??? example "Decision Log — Clinical Hold Prevention (RGDS-DEC-IND2026-008)"
    ```json
    {
...
??? example "Decision Log — Deficiency Prevention Example (RGDS-DEC-IND2026-005)"
    ```json
    {
...
??? example "Decision Log — Manufacturing Risk Gate (RGDS-DEC-IND2026-007)"
    ```json
    {
...
??? example "Decision Log — Protocol Amendment Gate (RGDS-DEC-IND2026-009)"
    ```json
    {
