...
??? example "Decision Log — Integration Example (RGDS-DEC-IND2026-003)"
    ```json
    {
...
??? example "Decision Log — RACI Consolidation (RGDS-DEC-IND2026-001)"
    ```json
    {
...
??? example "Decision Log — Risk Register Consolidation (RGDS-DEC-IND2026-002)"
    ```json
    {
...
??? example "Decision Log — AI Accountability Object"
    ```json
    {
      "aiassistance": {
        "used": true,
...
??? example "Decision Log — CMC Readiness Gate (RGDS-DEC-IND2026-004)"
    ```json
    {
